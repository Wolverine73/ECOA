...
%macro clean_tests;
	...
	2022.01.01 = dqi vt  only + disposition
	2022.01.02 = dqi dqi only + disposition
	2022.01.03 = stars only + no disposition
	2022.01.04 = stars only + disposition


	delete dss_cea2.dqi_eoms_cmctn_history     where execution_date >= '2022-01-01' and execution_date <= '2022-01-09';
	delete dss_cea2.dqi_eoms_files             where execution_date >= '2022-01-01' and execution_date <= '2022-01-09';
	delete dss_cea2.dqi_eoms_opportunity       where execution_date >= '2022-01-01' and execution_date <= '2022-01-09';
	delete dss_cea2.dqi_eoms_dispositions      where execution_date >= '2022-01-01' and execution_date <= '2022-01-09';
	delete dss_cea2.dqi_eoms_file_rule_metrics where execution_date >= '2022-01-01' and execution_date <= '2022-01-09';

	delete dss_cea2.dqi_eoms_cmctn_history     where source_opp_file   like any ( '%20220101%','%20220102%','%20220103%','%20220104%','%20220105%','%20220106%','%20220107%','%20220108%','%20220109%' );
	delete dss_cea2.dqi_eoms_cmctn_history     where source_opprx_file like any ( '%20220101%','%20220102%','%20220103%','%20220104%','%20220105%','%20220106%','%20220107%','%20220108%','%20220109%' );
	delete dss_cea2.dqi_eoms_files             where source_file       like any ( '%20220101%','%20220102%','%20220103%','%20220104%','%20220105%','%20220106%','%20220107%','%20220108%','%20220109%' );
	delete dss_cea2.dqi_eoms_opportunity       where source_opp_file   like any ( '%20220101%','%20220102%','%20220103%','%20220104%','%20220105%','%20220106%','%20220107%','%20220108%','%20220109%' );
	delete dss_cea2.dqi_eoms_dispositions      where source_opp_file   like any ( '%20220101%','%20220102%','%20220103%','%20220104%','%20220105%','%20220106%','%20220107%','%20220108%','%20220109%' );
	delete dss_cea2.dqi_eoms_file_rule_metrics where source_opp_file   like any ( '%20220101%','%20220102%','%20220103%','%20220104%','%20220105%','%20220106%','%20220107%','%20220108%','%20220109%' );
	
	delete dss_cea2.dqi_eoms_queue where execution_source = 'STARS' and execution_date = current_date;
	
	data _null_;
	x "rm /anr_dep/communication_history/eoms_files/*20220101*";
	x "rm /anr_dep/communication_history/eoms_files/*20220102*";
	x "rm /anr_dep/communication_history/eoms_files/*20220103*";
	x "rm /anr_dep/communication_history/eoms_files/*20220104*";
	x "rm /anr_dep/communication_history/eoms_files/*20220105*";
	x "rm /anr_dep/communication_history/eoms_files/*20220106*";
	x "rm /anr_dep/communication_history/eoms_files/*20220107*";
	x "rm /anr_dep/communication_history/eoms_files/*20220108*";
	x "rm /anr_dep/communication_history/eoms_files/*20220109*";
	
	x "rm /anr_dep/communication_history/dqi_files/*20220101*";
	x "rm /anr_dep/communication_history/dqi_files/*20220102*";
	x "rm /anr_dep/communication_history/dqi_files/*20220103*";
	x "rm /anr_dep/communication_history/dqi_files/*20220104*";
	x "rm /anr_dep/communication_history/dqi_files/*20220105*";
	x "rm /anr_dep/communication_history/dqi_files/*20220106*";
	x "rm /anr_dep/communication_history/dqi_files/*20220107*";
	x "rm /anr_dep/communication_history/dqi_files/*20220108*";
	x "rm /anr_dep/communication_history/dqi_files/*20220109*"; 
	
	x "rm /anr_dep/communication_history/stars_files/*20220101*";
	x "rm /anr_dep/communication_history/stars_files/*20220102*";
	x "rm /anr_dep/communication_history/stars_files/*20220103*";
	x "rm /anr_dep/communication_history/stars_files/*20220104*";
	x "rm /anr_dep/communication_history/stars_files/*20220105*";
	x "rm /anr_dep/communication_history/stars_files/*20220106*";
	x "rm /anr_dep/communication_history/stars_files/*20220107*";
	x "rm /anr_dep/communication_history/stars_files/*20220108*";
	x "rm /anr_dep/communication_history/stars_files/*20220109*"; 
	run;
	...
	%macro doit2;	
		...
		%do i = 1 %to 9;
			%let sftp_get_file2 = sfmc*.2022010&i*;
			%put NOTE: sftp_get_file2 = &sftp_get_file2. ;
...
%let ecoa_test		= YES6C; 						/* NO + YES1B + YES2B + YES3A B + YES4A B C + YES5B + YES6A B C **/
%let ecoa_zero		= NO;
...
run;	
	...
	%include "&c_s_core_dir./cd_data_integration_eoms.sas";	
